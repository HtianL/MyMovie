...
<div id="detail_movie">
		<Header title="影片详情">
			<i class="iconfont icon-right" @touchstart="backToMain()"></i>
		</Header>
			...
			<div class="detail_player swiper-container" ref="detail_player">
				<ul class="swiper-wrapper">
					<li v-for="(item,index) in detailMovie.photos" :key="index" class="swiper-slide">
						<div>
							<img :src="item | setWH('120.127')" alt="">
						</div>
					</li>
				</ul>
			</div>
...
<style>
#detail_movie{position:absolute;width:100%;min-height:100%;left:0;top:0;background-color: #fff;z-index:999;animation: detail .5s;}
@keyframes detail{
	from{
		left:100%;
	}to{
